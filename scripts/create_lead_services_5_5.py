...
assignment_service = """import logging
...
with open("backend/app/services/lead_assignment_service.py", "w", encoding="utf-8") as f:
    f.write(assignment_service)
    
with open("backend/app/services/lead_deduplication_service.py", "w", encoding="utf-8") as f:
    f.write(dedupe_service)

print("Created lead engine services")
